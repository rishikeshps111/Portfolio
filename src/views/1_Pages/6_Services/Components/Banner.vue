            ...
            <div class="mi-invert-fix">
                <div class="mil-banner-content mil-up">
                    ...
                    <div class="container">
                        ...
                        <a class="mil-link mil-accent mil-arrow-place mil-down-arrow"
                            @click="AnchorScroll('#services')">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6">
                                    <a href="service.html"
                                        ...
                                        <p class="mil-descr mil-light-soft mil-up mil-mb-30">Our creative agency is a
                                            team of professionals focused on helping your brand grow.</p>
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <a href="service.html"
                                        class="mil-service-card-lg mil-more mil-accent-cursor mil-offset">
                                        <h4 class="mil-muted mil-up mil-mb-30">Advertising and <br>Marketing Campaigns
                                        </h4>
                                        <p class="mil-descr mil-light-soft mil-up mil-mb-30">Our creative agency is a
                                            team of professionals focused on helping your brand grow.</p>
                                        <ul class="mil-service-list mil-light mil-mb-30">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <a href="service.html" class="mil-service-card-lg mil-more mil-accent-cursor">
                                        <h4 class="mil-muted mil-up mil-mb-30">Creative Consulting <br>Concept
                                            Development</h4>
                                        <p class="mil-descr mil-light-soft mil-up mil-mb-30">Our creative agency is a
                                            team of professionals focused on helping your brand grow.</p>
                                        <ul class="mil-service-list mil-light mil-mb-30">

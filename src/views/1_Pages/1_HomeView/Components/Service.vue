                ...
                <div class="mil-mb-120">
                    <div class="row">
                        <div class="col-lg-10">
                            ...
                            <span class="mil-suptitle mil-light-soft mil-suptitle-right mil-up">Professionals focused on
                                helping
                                your brand<br> grow and move forward.</span>
                    ...
                    <div class="mil-complex-text justify-content-center mil-up mil-mb-15">
                        ...
                        <span class="mil-text-image"><img src="/assets/img/photo/2.jpg" alt="team"></span>
                ...
                <div class="row mil-services-grid m-0">
                    <div class="col-md-6 col-lg-3 mil-services-grid-item p-0">
                        ...
                        <a href="service.html" class="mil-service-card-sm mil-up">
                            ...
                            <p class="mil-light-soft mil-mb-30">Our creative agency is a team of professionals focused
                                on helping
                                your brand grow.</p>
